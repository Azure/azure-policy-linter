      ...
      ""then"": {
        ""effect"": ""audit""
            ...
            ImplicitArrayEnumerationTests.AssertSingleFinding(
                ...
                linePosition: 60,
                path: "properties.policyRule.if.field",
                alias: "Microsoft.Test/testResource/items[*].name");
        }
      ...
      ""then"": {
            ...
            string alias = ImplicitArrayEnumerationTests.ArrayAlias)
        {
            ...
            var output = new LinterOutput(
                ...
                Path: path,
                Description:
                    $"The condition targets the members of array alias '{alias}', which performs an implicit 'allOf' evaluation over the array. Use a field count expression instead.");
