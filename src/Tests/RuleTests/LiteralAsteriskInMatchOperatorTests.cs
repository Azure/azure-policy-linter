    ...
    public class LiteralAsteriskInMatchOperatorTests
    {
            ...
            int linePosition)
        {
            ...
            var output = new LinterOutput(
                ...
                Description: $"The condition uses the '{operatorName}' operator with value '{operandValue}'. Match operators treat '*' literally; supported placeholders are '#' for digits, '?' for letters, and '.' for any character. Use those placeholders, or '{replacement}', whose wildcard syntax is different.");
        ...
        public void RuleTests_LiteralAsteriskInMatchOperator_ExactlyAsterisk()
        {
            ...
            var output = new LinterOutput(
                ...
                Description: "The condition uses the 'match' operator with value '*'. Match operators treat '*' literally; supported placeholders are '#' for digits, '?' for letters, and '.' for any character. Use those placeholders, or 'like', whose wildcard syntax is different.");
        ...
        public void RuleTests_LiteralAsteriskInMatchOperator_PropertyNameIsCaseInsensitive()
        {
            ...
            var output = new LinterOutput(
                ...
                LinePosition: 45,
                Path: "properties.policyRule.if.match",
                Description: "The condition uses the 'match' operator with value 'resource-*'. Match operators treat '*' literally; supported placeholders are '#' for digits, '?' for letters, and '.' for any character. Use those placeholders, or 'like', whose wildcard syntax is different.");
