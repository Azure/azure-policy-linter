namespace Microsoft.Azure.Policy.PolicyLinter.Tests
{
    ...
    public class TypeConditionFirstInAllOfTests
    {
        ...
        [Fact]
        public void RuleTests_TypeConditionFirstInAllOf_TypeIsFirst()
        {
        ...
        [Fact]
        public void RuleTests_TypeConditionFirstInAllOf_TypeIsNotFirst()
        {
            var linter = new PolicyLinter(
                rules: new ILinterRule[]
                {
        ...
        [Fact]
        public void RuleTests_TypeConditionFirstInAllOf_TypeAtIndexTwo()
        {
            var linter = new PolicyLinter(
                rules: new ILinterRule[]
                {
        ...
        [Fact]
        public void RuleTests_TypeConditionFirstInAllOf_NoTypeCondition()
        {
            var linter = new PolicyLinter(
                rules: new ILinterRule[]
                {
        ...
        [Fact]
        public void RuleTests_TypeConditionFirstInAllOf_SingleConditionAllOf()
        {
            var linter = new PolicyLinter(
                rules: new ILinterRule[]
                {
        ...
        [Fact]
        public void RuleTests_TypeConditionFirstInAllOf_AnyOfNotChecked()
        {
            var linter = new PolicyLinter(
                rules: new ILinterRule[]
                {
        ...
        [Fact]
        public void RuleTests_TypeConditionFirstInAllOf_CaseInsensitive()
        {
            var linter = new PolicyLinter(
                rules: new ILinterRule[]
                {
