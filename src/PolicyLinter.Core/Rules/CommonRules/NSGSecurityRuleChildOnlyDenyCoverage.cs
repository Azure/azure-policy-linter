...
namespace Microsoft.Azure.Policy.PolicyLinter.Core.Rules.CommonRules
{
    ...
    public sealed class NSGSecurityRuleChildOnlyDenyCoverage : LinterRule<PolicyDefinitionProperties>
    {
        ...
        private const string RuleDescription =
            "The alias '{0}' applies to security rules deployed as child resources. " +
            "Security rules submitted with the parent network security group are not covered. " +
            "Add equivalent parent resource coverage in this or another policy.";
