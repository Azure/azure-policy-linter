...
namespace Microsoft.Azure.Policy.PolicyLinter.Core.Expressions
{
    ...
    public class TemplateLanguageExpression : PolicyExpression
    {
        ...
        /// <summary>
        /// The name of the outermost function of the expression, if the expression is a function call.
        /// </summary>
        /// <example>
        /// [tryGet(field('a'), 'b')] => "tryGet"
        /// [coalesce(tryGet(field('a'), 'b'), '')] => "coalesce"
        /// [field('a')] => "field"
        /// 'literal' => null
        /// </example>
            ...
            PolicyExpression parent) : base(jTokenMetadata?.LineNumber, jTokenMetadata?.LinePosition, path, parent)
        {
            ...
            if (this.LanguageExpression is FunctionExpression rootFunction)
            {
                this.RootFunctionName = rootFunction.Function;
            }
